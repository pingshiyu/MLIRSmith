...
GEN_EXECUTABLE = BIN_DIR / "mlirsmith"
OPT_EXECUTABLE = BIN_DIR / "mlir-opt"
MLIR_DIR = Path("generated")
GEN_FAILED_DIR = Path("gen-failed")
CRASH_DIR = Path("crashed")
LOG_DIR = Path("error-logs")
TEMP_LOG = Path("temp.log")
SRC_MLIR = Path("src.mlir")
